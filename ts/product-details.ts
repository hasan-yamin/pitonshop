...
let productId: number; // ID for product will appear in product details page
let usertoken = <string>localStorage.getItem('tempUserAuth');//user authentication token
...
function showProduct(product: { image: string; likes: any[]; name: string; description: string; price: number; }) {
